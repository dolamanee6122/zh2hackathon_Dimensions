    ...
    <Card>
      ...
      >
        ...
        >
          ...
          <div className="req-paymentmode">
            {data.paymentMode.toUpperCase()}
          </div>
          {data.balanceShopWise.debit === 0 &&
            data.balanceShopWise.credit === 0 && (
              <div className="new">NEW!</div>
            )}
          {(data.balanceShopWise.credit !== 0 ||
            data.balanceShopWise.debit !== 0) && (
            <div className="req-balance">{data.balanceShopWise.balance}</div>
          )}
        </div>
        <div
          style={{
        ...
        >
          ...
          <div className={data.recordType === "CREDIT" ? "red" : "green"}>
            {data.recordType}
          </div>
        ...
        <div>
          <p
            style={{ fontWeight: "600", marginLeft: "24px" }}
            className={data.status === "APPROVED" ? "green" : "red"}
          >
            {data.status}
          </p>
        </div>
